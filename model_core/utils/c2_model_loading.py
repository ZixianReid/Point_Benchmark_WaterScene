...
from model_core.utils.registry import Registry
...
def load_resnet_c2_format(cfg, f):
    ...
    conv_body = cfg.MODEL.IMG_BACKBONE.CONV_BODY
...
def load_c2_format(cfg, f):
    return C2_FORMAT_LOADER[cfg.MODEL.IMG_BACKBONE.CONV_BODY](cfg, f)
